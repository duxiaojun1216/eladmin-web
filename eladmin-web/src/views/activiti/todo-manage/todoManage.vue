  ...
  export default {
    ...
    methods: {
      ...
      ***/
      ...
      handelSubmit() {
        if (this.form.border == '是') {
          this.form.comment = '是农民工'
        }
        if (this.form.soldier == '是') {
          this.form.comment = '是退役军人'
        }
        if (this.form.graduate == '是') {
          this.form.comment = '是高校毕业生'
        }
        if (this.form.foreign == '是') {
          this.form.comment = '是外来创业人员'
        }
      ...
      passTask(v) {
        if (v.variables.bh.substring(0, 2) == 'nm') {
          this.isborder = true;   //农民
          this.isgraduate =false;
          this.isforeign = false;
          this.issoldier =false;
        }else if(v.variables.bh.substring(0, 2) == 'gx') {
          this.isgraduate = true;  //高校
          this.isborder = false;
          this.isforeign = false;
          this.issoldier = false;
        }else if (v.variables.bh.substring(0, 2) == 'wl'){
          this.isforeign = true;  //外来
          this.isborder = false;
          this.isgraduate =false;
          this.issoldier =false;
        }else if (v.variables.bh.substring(0, 2) == 'ty'){
          this.issoldier= true; //退役
          this.isborder = false;   //农民
          this.isgraduate =false;
          this.isforeign = false;
        }
