...
// 导出模型
export const exportModel = "/api/actModel/export/"
// 通过文件部署模型流程
export const deployByFile = "/api/actModel/deployByFile"
// 导出流程资源
export const exportResource = "/api/actProcess/export"
// 获取高亮实时流程图
export const getHighlightImg = "/api/actProcess/getHighlightImg/"
